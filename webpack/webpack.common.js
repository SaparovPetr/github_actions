...
module.exports = {
	...
	output: {
		...
		publicPath: process.env.PUBLIC_PATH ? process.env.PUBLIC_PATH : '/', // указываем путь, который будет добавляться перед подключением файлов		chunkFilename: 'static/scripts/[name].[contenthash].bundle.js'
